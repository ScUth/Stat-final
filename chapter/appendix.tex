...
\end{figure}
% ────────── User settings ──────────
% 1) Your data: comma‐separated “percent/label”
\def\pieData{23.91/Sunday, 15.21/Thursday, 15.21/Tuesday, 13.04/Wednesday, 13.04/Friday, 13.04/Saturday, 6.52/Monday}

% 2) Colors (pgf list) and count
\def\pieColors{{"red","Orange","magenta","Green","cyan","violet","Gold2"}}
\def\colorCount{7}
...
\begin{figure}[h]
  ...
  \end{tikzpicture}
  \caption{Pie chart with legend to the right (always outside).}
\end{figure}

\def\pieData{58.7/Entertainment, 34.8/Social, 4.3/Education, 2.2/Information and Reading}

% 2) Colors (pgf list) and count
\def\pieColors{{"Orange","red","magenta","Green"}}
\def\colorCount{4}
...
\def\pieData{28.3/Monday, 19.6/Saturday, 19.6/Thursday, 10.9/Sunday, 10.9/Wednesday, 8.7/Tuesday, 2.2/Friday}

% 2) Colors (pgf list) and count
\def\pieColors{{"Gold2","violet","Orange","red","Green","magenta","cyan"}}
\def\colorCount{7}
...
\def\pieData{69.6/None, 23.9/Astigmatism, 2.17/Cataract, 2.17/Color blindness, 2.17/Pinguecula}

% 2) Colors (pgf list) and count
\def\pieColors{{"Gold2","violet","Orange","red","cyan"}}
\def\colorCount{7}
...
\begin{table}
    ...
    \begin{adjustbox}{width = 0.4\textwidth, center}
        \begin{tabular}{|cll|c|}
            ...
            \multicolumn{3}{|c|}{\cellcolor[HTML]{FFE599}$\widehat{\rho}_{X,Y}= \frac{\widehat{\mathrm{cov}}_{X, Y}}{s_X\cdot s_Y}}$        & -0.1242    \\ \hline
        \end{tabular}
    \end{adjustbox}
\end{table}\\
\begin{table}
...
\begin{table}
    ...
    \begin{adjustbox}{width = 0.4\textwidth, center}
        \begin{tabular}{|cll|c|}
            ...
            \multicolumn{3}{|c|}{\cellcolor[HTML]{FFE599}$\widehat{\rho}_{X,Y}= \frac{\widehat{\mathrm{cov}}_{X, Y}}{s_X\cdot s_Y}}$        & -0.1148    \\ \hline
        \end{tabular}
    \end{adjustbox}
\end{table}